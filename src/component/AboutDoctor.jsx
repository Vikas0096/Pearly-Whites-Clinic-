...
const AboutDoctor = () => {
  return (
    <>
      {/* Main container with responsive margin, padding, and flex direction */}
      <div className='flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 m-4 md:m-10 p-6 bg-[#84cffa] text-primary rounded-lg'>
        ...
        {/* Responsive image with a circular shape */}
        <img 
          src={assets.drimage} 
          alt="Dr. Ravi Tiwari" 
        ...
        {/* Text container with responsive text alignment and gap */}
        <div className='flex flex-col gap-2 text-center md:text-left'>
          ...
          {/* Paragraph with max-width for better readability */}
